...
GRANT ROLE AIRFLOW_ROLE TO USER DBT_USER;
GRANT USAGE ON WAREHOUSE DBT_WH TO ROLE AIRFLOW_ROLE;
-- ===========================================================================
...
-- 1. Droits sur la gestion des dossiers et logs
GRANT DELETE ON TABLE DOSSIERS_DB.PROD.DOSSIERS TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE DOSSIERS_DB.PROD.FILES_LOG TO ROLE STREAMLIT_ROLE;

-- 2. Droits sur TOUTES les tables de données brutes (RAW)
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_MT20 TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_MT24 TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_ANNUAIRE TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_HREF_EVENTS_ORANGE TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_HREF_CELLS_ORANGE TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_HREF_SFR TO ROLE STREAMLIT_ROLE;
GRANT DELETE ON TABLE RAW_DATA.PNIJ_SRC.RAW_HREF_BOUYGUES TO ROLE STREAMLIT_ROLE;